...
const featuredProducts = [  
    { id: 1, name: 'Library Stool Chair', price: 99, imageUrl: '/p9.png', Link:'/product9' },  
    { id: 2, name: 'Library Stool Chair', price: 99, imageUrl: '/p1.png', Link:'product1' },  
    { id: 3, name: 'Library Stool Chair', price: 99, imageUrl: '/p2.png', Link:'product2' },  
    { id: 4, name: 'Library Stool Chair', price: 99, imageUrl: '/p3.png', Link:'product3' },  
    { id: 5, name: 'Library Stool Chair', price: 99, imageUrl: '/p4.png' , Link:'product4'},  
  ];  
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row bg-white ">  
      ...
      <div className="md:w-1/2 p-10">  
        <Image  
          src="/p8.png" // Replace with your image path  
