...
const featuredProducts = [  
    { id: 1, name: 'Library Stool Chair', price: 99, imageUrl: '/p6.png', Link:'/product6' },  
    { id: 2, name: 'Library Stool Chair', price: 99, imageUrl: '/p7.png', Link:'product7' },  
    { id: 3, name: 'Library Stool Chair', price: 99, imageUrl: '/p8.png', Link:'product8' },  
    { id: 4, name: 'Library Stool Chair', price: 99, imageUrl: '/p9.png', Link:'product9' },  
    { id: 5, name: 'Library Stool Chair', price: 99, imageUrl: '/p1.png' , Link:'product1'},  
  ];  
