...
const featuredProducts = [  
    { id: 1, name: 'Library Stool Chair', price: 99, imageUrl: '/p5.png', Link:'/product5' },  
    { id: 2, name: 'Library Stool Chair', price: 99, imageUrl: '/p6.png', Link:'product6' },  
    { id: 3, name: 'Library Stool Chair', price: 99, imageUrl: '/p7.png', Link:'product7' },  
    { id: 4, name: 'Library Stool Chair', price: 99, imageUrl: '/p8.png', Link:'product8' },  
    { id: 5, name: 'Library Stool Chair', price: 99, imageUrl: '/p9.png' , Link:'product9'},  
  ];  
  ...
  return (
    ...
    <div className="flex flex-col md:flex-row bg-white ">  
      ...
      <div className="md:w-1/2 p-10">  
        <Image  
          src="/p4.png" // Replace with your image path  
