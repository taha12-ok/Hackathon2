...
const featuredProducts = [  
    { id: 1, name: 'Library Stool Chair', price: 99, imageUrl: '/p2.png', Link:'/product2' },  
    { id: 2, name: 'Library Stool Chair', price: 99, imageUrl: '/p3.png', Link:'product3' },  
    { id: 3, name: 'Library Stool Chair', price: 99, imageUrl: '/p4.png', Link:'product4' },  
    { id: 4, name: 'Library Stool Chair', price: 99, imageUrl: '/p5.png', Link:'product5' },  
    { id: 5, name: 'Library Stool Chair', price: 99, imageUrl: '/p6.png' , Link:'product6'},  
  ];  
